...
Ensuring usability on touch-screen devices.

== Screenshots ==

1. AJAX Plugin for AdSense Dashboard.
...
Although the AJAX Plugin for AdSense plugin is designed to handle Google AdSense efficiently, there is nothing preventing you from using the text boxes to place any other kind of text in your blog posts and pages. In particular, you can use ad text from other providers, especially in the header and footer.
...
* V8.65: Ensuring usability on touch-screen devices. [Sep 17, 2015]
